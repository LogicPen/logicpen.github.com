...
function frameOneAnimation(){
	tl1.fromTo(frame1Text1,0.4, {x:320}, {x:0, ease:Power4.easeIn});
	tl1.to(frame1Text1Shasow,0.2, {textShadow: 'rgb(255, 255, 255) 0px 0px 0px'});
	tl1.fromTo(frame1Text2,0.4, {x:320}, {x:0, ease:Power4.easeIn},1.9);
	tl1.to(frame1Text2Shasow,0.2, {textShadow: 'rgb(255, 255, 255) 0px 0px 0px'});
	tl1.to([frame1Text1,frame1Text2],0.2, {x:-320, opacity: 0, ease:Power4.easeIn},3.8);
	tl1.fromTo(frame1Text3,0.4, {x:320}, {x:0, ease:Power4.easeIn},3.7);
	tl1.to(frame1Text3Shasow,0.2, {textShadow: 'rgb(255, 255, 255) 0px 0px 0px'});
	tl1.to(frame1Text3,0.2, {x:-320, opacity: 0, ease:Power4.easeIn, onComplete: function(){
		tl2.play();
	}},5.3);
}
